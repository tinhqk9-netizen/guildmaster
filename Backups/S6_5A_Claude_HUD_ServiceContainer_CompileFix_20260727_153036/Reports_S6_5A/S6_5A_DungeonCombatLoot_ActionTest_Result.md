...
| Loot in area chest | PendingDrops non-empty | 1 entries / 1 items after 1208 ticks | PASS |
...
| Dungeon progress | progress advanced during the run | progress=0 | **FAIL** |
| Save/reload inventory | looted item still present (beast_pelt) | 1 | PASS |
| Save/reload progress | progress preserved (0) | 0 | PASS |
| OVERALL | damage + death + chest loot + collect + persist | all verified in 1208 ticks | PASS |
