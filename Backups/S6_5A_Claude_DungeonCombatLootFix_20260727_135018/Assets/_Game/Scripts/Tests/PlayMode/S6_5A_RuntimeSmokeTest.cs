...
namespace GuildMaster.Tests.PlayMode
{
    public class S6_5A_RuntimeSmokeTest
    {
        ...
        public IEnumerator RunFullSmokeTest()
        {
            ...
            // Initialize Tavern manually since UIRuntimeBootstrap didn't list it explicitly
            if (tavern != null) tavern.Initialize(services.Tavern);
            if (craft != null) craft.Initialize(services.Craft);
            if (merchant != null) merchant.Initialize(services.Merchant);
