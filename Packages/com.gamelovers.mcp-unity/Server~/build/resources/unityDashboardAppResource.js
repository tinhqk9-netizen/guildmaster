...
export function registerUnityDashboardAppResource(server, logger) {
    logger.info(`Registering resource: ${resourceName}`);
    registerAppResource(server, resourceName, appResourceUri, {
    ...
    server.resource(legacyResourceName, legacyResourceUri, {
...
function readDashboardHtml(uriOverride) {
...
export function readUnityDashboardHtml() {
...
function resolveDashboardPath() {
    ...
    throw new Error(`Unity dashboard UI file is missing. Checked: ${candidates.join(', ')}`);
}
