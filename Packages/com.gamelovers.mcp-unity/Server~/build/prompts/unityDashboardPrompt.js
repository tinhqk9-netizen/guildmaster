 ...
 */
export function registerUnityDashboardPrompt(server) {
    server.prompt('unity_dashboard', 'Opens the Unity dashboard MCP app in VS Code with real-time Unity Editor information', {}, async () => ({
        messages: [
            {
                role: 'user',
                content: {
