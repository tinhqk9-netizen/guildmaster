import { remoteId, disconnectRemoteNode, connectRemoteNode, serializeRemoteNode, setRemoteId } from './internals.mjs';
...
class RemoteMutationObserver extends MutationObserver {
  ...
  observe(target, options) {
    ...
    if (options?.initial !== false && target.childNodes.length > 0) {
      if (id !== ROOT_ID) {
        this.connection.mutate([[MUTATION_TYPE_INSERT_CHILD, ROOT_ID, serializeRemoteNode(target), this.#observed.size - 1]]);
