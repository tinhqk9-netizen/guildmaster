import { ROOT_ID, MUTATION_TYPE_INSERT_CHILD } from '../constants.mjs';
import { setRemoteId, remoteConnection, connectRemoteNode, serializeRemoteNode, updateRemoteElementProperty, callRemoteElementMethod } from './internals.mjs';
